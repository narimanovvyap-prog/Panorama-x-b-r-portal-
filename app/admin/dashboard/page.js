...
export default function AdminDashboard() {
  ...
  async function handleVideoUpload(e) {
    ...
    if (!file.type.startsWith('video/')) {
      setMessage('❌ Zəhmət olmasa video faylı seç.');
      e.target.value = '';
      return;
    }
  ...
  async function handleAdImageUpload(e) {
    ...
    const fileName = `reklam-${Date.now()}-${Math.random()
      .toString(36)
      .substring(2, 8)}-${safeName}`;
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-2">
                Bir şəkil və ya bir neçə şəkil seçə bilərsən.
              </p>
                    ...
                    (url, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 bg-crimson text-white rounded-full w-7 h-7 text-sm"
                        >
                          ×
                        </button>
